...
const enFallback = {
  ...
  "account": "Account",
  "accountSyncIntro": "Sign in to sync your travel planning context across supported sessions.",
  "loadingAccount": "Loading account…",
  "authTempUnavailable": "Authentication is temporarily unavailable.",
  "googleSignInUnavailable": "Google sign-in is not available right now.",
  "signedInAs": "Signed in as",
  "traveler": "Traveler",
  "signInFailed": "Sign-in failed.",
  "enterEmailMagicLink": "Enter your email to receive a magic link.",
  "emailSignInUnavailable": "Email sign-in is not available right now.",
  "checkEmailSignInLink": "Check your email for a sign-in link.",
  "unableSendMagicLink": "Unable to send magic link.",
  "signOutUnavailable": "Sign out is not available right now.",
